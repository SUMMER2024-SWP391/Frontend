      ...
      <div className='grid grid-cols-10'>
        ...
        <div className='col-span-8'>
          <Routes>
            ...
            <Route path='list-event-operator' element={<TableUser role={UserRole.EventOperator} />} />
            <Route path='list-visitor' element={<TableUser role={UserRole.Visitor} />} />
            <Route path='list-all-event' element={<AdminTableEventList />} />
            <Route path='create-event-operator' element={<CreateEventOperator />} />
          </Routes>
        </div>
      </div>
    </div>
